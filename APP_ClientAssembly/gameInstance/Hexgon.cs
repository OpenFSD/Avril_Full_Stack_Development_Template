using Avril_FSD.ClientAssembly;
...
namespace ClientAssembly.GameInstance
{
    public class Hexgon
    {
        ...
        public Hexgon()
        {
            ...
            Console.WriteLine("Avril_FSD.ClientAssembly: Map_Default");
        }

        public void Draw_Square(Avril_FSD.ClientAssembly.Framework_Client obj, Data data)
        {
            GL.DrawElements(
                PrimitiveType.Triangles,
                data.Get_gameInstance().Get_gameData_Output().Get_Indices().Length,
