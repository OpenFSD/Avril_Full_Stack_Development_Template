...
namespace Avril_FSD.ClientAssembly.Graphics
{
    public class GameObjectFactory : IDisposable
    {
        ...
        private Avril_FSD.ClientAssembly.GameInstance.Player _player;
        ...
        {
            _player = new Avril_FSD.ClientAssembly.GameInstance.Player(
                _models["Player"],
        ...
        public Avril_FSD.ClientAssembly.GameInstance.Player Get_player()
        {
            return _player;
        }
    }
