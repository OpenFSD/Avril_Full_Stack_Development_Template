using Avril_FSD.ServerAssembly;
...
namespace ServerAssembly.GameInstance
{
    public class Hexgon
    {
        ...
        public Hexgon()
        {
            ...
            Console.WriteLine("Avril_FSD.ServerAssembly: Map_Default");
        }

        public void Draw_Square(Avril_FSD.ServerAssembly.Framework_Server obj, Data data)
        {
            GL.DrawElements(
