namespace Avril_FSD.ServerAssembly.Outputs
{
    public class Output
    {
        private Avril_FSD.ServerAssembly.Outputs.Output_Control _output_Control;
        ...
        {
            _output_Control = new Avril_FSD.ServerAssembly.Outputs.Output_Control();
            while (_output_Control == null) { /* Wait while is created */ }
        }
        public Output_Control Get_output_Control()
        {
