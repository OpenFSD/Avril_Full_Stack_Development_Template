...
namespace Avril_FSD.ServerAssembly.Graphics
{
    public class GameObjectFactory : IDisposable
    {
        ...
        private Avril_FSD.ServerAssembly.GameInstance.Player _player;
        ...
        {
            _player = new Avril_FSD.ServerAssembly.GameInstance.Player(
                _models["Player"],
        ...
        public Avril_FSD.ServerAssembly.GameInstance.Player Get_player()
        {
            return _player;
        }
    }
